...
public class ViewAllWorkers extends Fragment implements Inter<String>{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_view_all_workers, container, false);
...
public void function()
{
    ...
    public void start(String flag){
        Webface upload=new Webface(getContext(), (Inter<String>)ViewAllWorkers.this);
