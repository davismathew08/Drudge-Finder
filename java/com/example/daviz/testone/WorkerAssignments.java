...
public class WorkerAssignments extends Fragment implements Inter<String>{
    ...
    String cust_phoneno[]=new String[50];
    Button lin_btn;
    int j,count=0,k=0;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_worker_workassignments, container, false);
    ...
    public void function()
    {
        ...
        for (j=0; j < count; j++) {
            ...
            tv.setText(customername[j]);
            tv.setTextSize(15);
            tv.setId(j);
            tv.setPadding(20,16,20,20);

            tvv.setText(cust_phoneno[j]);
            tvv.setTextSize(15);
            tvv.setId(j);
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    txt_text.setText("assigned");
                    v.setVisibility(View.GONE);
                    Intent i=new Intent(getContext(),Worker_Customer_Assign.class);
                    i.putExtra("cust_phone_no",tvv.getText().toString());
                    i.putExtra("worker_mail",value);
                    startActivity(i);
                    /*txt_text.setText("approved");
                    v.setVisibility(View.GONE);
                    idd=tv.getText().toString();*/
                    //Toast.makeText(getActivity(),tvv.getText().toString()+value, Toast.LENGTH_LONG).show();
    ...
    public void start(String flag){
        Webface upload=new Webface(getContext(), (Inter<String>)WorkerAssignments.this);
        ...
        else
        {
            ...
            try {
                ...
                for(int i=0;i<jsonArray.length();i++){
                    ...
                    customername[i]=jsonObject.getString("cust_name");
                    Log.d("Jsonobj","col1"+jsonObject.getString("phone_no"));
                    cust_phoneno[i]=jsonObject.getString("phone_no");
                    count++;
                ...
                Log.d("count","" +count);
                for(int i=0;i<jsonArray.length();i++){
                    Log.d("id","" + customername[i]);
                    Log.d("name","" +cust_phoneno[i]);
                }
                function();
